...
for column in train_data.columns:
    if column == 'Diagnosis':
        continue
    train_data[column] = pd.qcut(train_data[column], q=4, labels=['1', '2', '3', '4'])

for column in test_data.columns:
    if column == 'Diagnosis':
        continue
    test_data[column] = pd.qcut(test_data[column], q=4, labels=['1', '2', '3', '4'])

tree = id3(train_data, 'Diagnosis')
print('Tree: ', tree)

accuracy = evaluate(tree, test_data, 'Diagnosis')
